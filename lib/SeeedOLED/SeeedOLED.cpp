...
//custom
void SeeedOLED::putPixel(unsigned int x, unsigned int y, bool dark)
{
    //TODO: reset page/column to full size

    



    sendCommand(0xB0 + 1);            //set page address
    sendData(0x1);
    sendData(0x2);
    sendData(0x4);
    sendData(0x8);

    sendCommand(0xB0 + 2);            //set page address
    sendData(0x1);
    sendData(0x81);
    sendData(0x1);
    sendData(0x1);
